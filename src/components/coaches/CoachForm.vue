<template>
  <form @submit.prevent="submitForm">
    <div class="form-controll" :class="{ invalid: !firstName.isValid }">
      <label for="firstname">Firstnmame</label>
      <input type="text" id="firstname" v-model.trim="firstName.val" @blur="clearValidity('firstName')">
      <p v-if="!firstName.isValid">Firstname must not be empty.</p>
    </div>
    <div class="form-controll" :class="{ invalid: !lastName.isValid }">
    ...
    <div class="form-controll" :class="{ invalid: !description.isValid }">
    ...
    <div class="form-controll" :class="{ invalid: !areas.isValid }">
